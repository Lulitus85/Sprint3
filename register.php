  ...
  <main class="register">
    <div class="cajita-texto">
      ...
      <p class="texto_bienvenida">
        ...
        Las reglas son simples, somos un <strong>ecommerce de “intercambio”</strong>: solicitas un producto, el oferente
        ingresa a tu
    ...
    <div class="cajita2">
      ...
      <form class="formularioRegister" action="" method="POST" enctype="multipart/form-data">
        <input class="inputForm" type="text" name="userName" placeholder="Usuario"
          value="<?=isset($errors["userName"])? "" :inputUsuario("userName");?>">
        ...
        <input class="inputForm" type="text" name="email" placeholder="Correo electrónico"
          value="<?=isset($errors["email"])? "":inputUsuario("email");?>">
        <!--persistencia de datos :D-->
        ...
        <div class="dob">
          ...
          <select name="DOBMonth">
            ...
            <option value="Febrero">Febuary</option>
